...
class _HomeState extends State<Home> {
      ...
      setState(() {
        kitaplar.add(
          Kitap(
              ...
              fiyat: element.children[7].children[1].text.toString()),
        );
      });
    });
    setState(() {
          ...
          : SafeArea(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) => Card(
                  ...
                  elevation: 6,
                  color: const Color.fromARGB(221, 104, 100, 100),
                  child: Padding(
  ...
  final TextStyle _style = const TextStyle(color: Color.fromARGB(255, 255, 255, 255), fontSize: 15);
}
